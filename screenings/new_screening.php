    ...
    <body>
        ...
        <form name="screening" method="post" enctype="multipart/form-data" action="screening_submit.php">
            <table>
                ...
                <tr><td>Poster</td><td align="right"><input name="Poster" type="file" id="file"></td></tr>
                <tr>
                    <td>Message</td><td align="right"><input type="text" name="Message"></td>
                </tr>
                <tr>
                    <td>Email</td><td align="right"><input name="Email" type="email"></td>
                </tr>
                <tr>
